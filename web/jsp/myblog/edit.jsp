...
<form class="layui-form" action="edit.myblog" style="width: 60%;margin-left: 15%;margin-top: 20px">
    <label class="layui-form-label">标题</label>
    <div class="layui-input-block">
        <input type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input" value="${myblog.title}">
    </div>
        ...
        <div class="layui-input-block">
            <select name="tagId" lay-filter="aihao">
                <c:forEach items="${tagList}" var="tag">
                    <c:choose>
                        <c:when test="${tag.id == myblog.tagId}">
    ...
    <div class="layui-input-block">
        <textarea placeholder="请输入内容" class="layui-textarea" name="content">${myblog.content}</textarea>
    </div>
    <label class="layui-form-label"></label>
    <input type="text" value="${myblog.id}" name="blogId" hidden="hidden">
    <input type="text" value="${sessionScope.checkedUserId}" name="userId" hidden="hidden">
